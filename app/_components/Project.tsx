  ...
  return (
    ...
    >
      {selectedProject === null && (
        <Image
          src={project.thumbnail || "/placeholder.svg?height=300&width=200"}
          alt="Project"
          width={300}
          height={200}
        ...
        <div className="">
          <h4 className="text-4xl xs:text-6xl flex gap-4 font-anton transition-all duration-700 bg-gradient-to-r from-primary to-foreground from-[50%] to-[50%] bg-[length:200%] bg-right bg-clip-text text-transparent group-hover:bg-left">
            ...
            {project.status === "developing" && (
              <span className="text-xs font-normal bg-yellow-500/20 text-yellow-500 px-2 py-1 rounded-full self-start">
                Under Development
              </span>
            )}
